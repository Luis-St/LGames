...
public enum DiceState implements EnumRepresentable {
	...
	private DiceState(String name, int id, String path) {
		this.name = name;
		this.id = id;
		this.path = path;
	}
	...
	@Nullable
	public static DiceState fromCount(int count) {
		DiceState state = EnumRepresentable.fromId(DiceState.class, count);
